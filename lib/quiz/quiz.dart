...
import 'package:sioquizz/quiz/quiz_state.dart';
import 'package:sioquizz/services/firestore.dart';
import 'package:sioquizz/services/models.dart';
import 'package:sioquizz/shared/loading.dart';
import 'package:sioquizz/shared/progress_bar.dart';
          ...
          ButtonBar(
            ...
            children: <Widget>[
              ElevatedButton.icon(
                ...
                label: const Text('Commencer Quizz'),
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(
            'Félicitation! Vous avez finis le Quizz "${quiz.title}"',
          ...
          ElevatedButton.icon(
            ...
            onPressed: () {
              ...
              Navigator.pushNamedAndRemoveUntil(
                context,
                '/topics',
                (route) => false, //Routes vers topics
              );
            },
          )
        ],
